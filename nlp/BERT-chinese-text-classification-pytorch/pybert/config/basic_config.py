...
configs = {
    'arch':'bert',
    'raw_data_path': path.sep.join([BASE_DIR,'dataset/raw/cnews.train.txt']),   # 总的数据，一般是将train和test何在一起构建语料库
    ...
    'vocab_path': path.sep.join([BASE_DIR, 'model/pretrain/chinese-bert_chinese_wwm_pytorch/vocab.txt']),
    'tf_checkpoint_path': path.sep.join([BASE_DIR, 'model/pretrain/chinese-bert_chinese_wwm_pytorch/bert_model.ckpt']),
    'bert_config_file': path.sep.join([BASE_DIR, 'model/pretrain/chinese-bert_chinese_wwm_pytorch/bert_config.json']),
